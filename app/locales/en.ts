export default {
  ...
  pages: {
    ...
    contact: {
      ...
      intro:
        "Reach out for engineering leadership, product-building, systems design, or a sharp second opinion.",
    },
    writing: {
      seo: "Writing — Bojan Angjelkoski",
      eyebrow: "Writing",
      title: "Writing.",
      intro:
        "Thoughts on software engineering, team building, and systems design.",
      backLink: "← All writing",
    },
  },

  footer: {
    copyrightName: "Bojan Angjelkoski",
    github: "GitHub",
    linkedin: "LinkedIn",
    twitter: "Twitter / X",
  },
  ...
  error: {
    ...
    serverErrorDescription: "Something went wrong while loading this page.",
