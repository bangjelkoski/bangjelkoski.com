...
usePageSeo("About me - Bojan Angjelkoski's Portfolio Website", { bodyClass: 'about' })
</script>
...
<template>
  <section>
    ...
    <p>
      With a solid foundation and <NuxtLink :to="{ name: 'skills' }">twelve years of experience as a developer</NuxtLink>,
    ...
    <p>
      Want to learn more? You can reach out and I will be
      delighted to reply 😄
    </p>
  </section>
</template>
